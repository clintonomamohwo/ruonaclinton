...
module RbConfig
  RUBY_VERSION.start_with?("2.7.") or
    raise "ruby lib version (2.7.2) doesn't match executable version (#{RUBY_VERSION})"

  # Ruby installed directory.
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.7.0/arm64-darwin20")
  ...
  CONFIG["MINOR"] = "7"
  CONFIG["TEENY"] = "2"
  CONFIG["PATCHLEVEL"] = "137"
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/ruonaclinton/.rbenv/versions/2.7.2")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/ruonaclinton/.rbenv/versions/2.7.2' '--with-openssl-dir=/Users/ruonaclinton/.rbenv/versions/2.7.2/openssl' '--enable-shared' '--with-readline-dir=/opt/homebrew/opt/readline' 'CC=clang' 'LDFLAGS=-L/Users/ruonaclinton/.rbenv/versions/2.7.2/lib ' 'CPPFLAGS=-I/Users/ruonaclinton/.rbenv/versions/2.7.2/include '"
  ...
  CONFIG["arch"] = "arm64-darwin20"
  CONFIG["sitearchincludedir"] = "$(includedir)/$(sitearch)"
  CONFIG["archincludedir"] = "$(includedir)/$(arch)"
  CONFIG["sitearchlibdir"] = "$(libdir)/$(sitearch)"
  CONFIG["archlibdir"] = "$(libdir)/$(arch)"
  CONFIG["libdirname"] = "libdir"
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/ruonaclinton/.rbenv/versions/2.7.2"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/Users/ruonaclinton/.rbenv/versions/2.7.2/lib  -Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress"
  CONFIG["ALLOCA"] = ""
  CONFIG["MATHN"] = "yes"
  ...
  CONFIG["RANLIB"] = ":"
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "Apple clang version 13.0.0 (clang-1300.0.29.3)\nTarget: arm64-apple-darwin20.6.0\nThread model: posix\nInstalledDir: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin"
  ...
  CONFIG["CXX"] = "clang++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/Users/ruonaclinton/.rbenv/versions/2.7.2/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/Users/ruonaclinton/.rbenv/versions/2.7.2/lib  -fstack-protector-strong"
  CONFIG["CFLAGS"] = "$(cflags)  -fno-common -pipe"
  CONFIG["CC"] = "clang"
  CONFIG["target_os"] = "darwin20"
  CONFIG["target_vendor"] = "apple"
  CONFIG["target_cpu"] = "arm64"
  CONFIG["target"] = "arm64-apple-darwin20"
  CONFIG["host_os"] = "darwin20.6.0"
  CONFIG["host_vendor"] = "apple"
  CONFIG["host_cpu"] = "arm"
  CONFIG["host"] = "arm-apple-darwin20.6.0"
  CONFIG["RUBY_VERSION_NAME"] = "$(RUBY_BASE_NAME)-$(ruby_version)"
  CONFIG["RUBYW_BASE_NAME"] = "rubyw"
  CONFIG["RUBY_BASE_NAME"] = "ruby"
  CONFIG["build_os"] = "darwin20.6.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "arm"
  CONFIG["build"] = "arm-apple-darwin20.6.0"
